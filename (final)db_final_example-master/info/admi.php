			...
			<div class="row">
				<table class="table">
					...
					if($person->account==$account){?>
						<tr>
						<td scope="row" style="color:Tomato; font-size: 20px;"><?php echo $person->id; ?></td>
		                <td class="text-center" style="color:Tomato; font-size: 20px;"><?php echo $person->account; ?></td>
		                <td class="text-center" style="color:Tomato; font-size: 20px;"><?php echo $person->user_name; ?></td>
		                <td class="text-center" style="color:Tomato; font-size: 20px;"><?php echo $person->mail; ?></td>
		                <td class="text-center" style="color:Tomato; font-size: 20px;"><?php echo $person->identity; ?></td>
